...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	containerUpdateClient, err := repository.ProvideImageUpdaterClient(configConfig)
	if err != nil {
		return nil, err
	}
	updateService := service.ProvideUpdateService(configConfig, updateCache, gitHubReleaseClient, serviceBuildInfo, containerUpdateClient)
